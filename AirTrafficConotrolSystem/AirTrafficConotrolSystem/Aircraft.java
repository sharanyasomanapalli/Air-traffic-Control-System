...
{
	private String callsign; //no change
	private int altitude; //change
	private int speed; //change
	private boolean landingclearence; //no change
	private boolean takeoffclearence; //no change
	...
	public void granttakeoffclearence() //gives permission
	{
		this.takeoffclearence=true;
	}
	public void revoketakeoffclearence() // take back permission
	{
